...
# Hesap
API_ID = getenv("API_ID", "2930013")
API_HASH = getenv("API_HASH", "7cab92dcd979add511b79d693775e17d")
TOKEN = getenv("TOKEN", "6803669543:AAF3IVN9OQvi0DFESZSX2Nc4W2YGFBO6__c")
USERNAME = getenv("USERNAME", "MytGrupBot")
OWNER_ID = getenv("OWNER_ID", "1527476177")
